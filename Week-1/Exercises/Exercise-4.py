...
largest_value = max(dct, key=dct.get)
print(largest_value)
...
jazzpop = []
for r in responses: 
    jazzpop.append(responses_mapping[r])
...
sorted_animals_alphabet = {k: animals[k] for k in sorted(animals)}

print(sorted_animals_alphabet)
...
sorted_animals_value = {k: animals[k] for k in sorted(animals, key=animals.get)}

print(sorted_animals_value)
